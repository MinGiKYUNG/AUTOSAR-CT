...
public class TC_CANNM_0091 extends TC_CANNM {
	...
	public static double execute(String conf) throws ParserConfigurationException, SAXException, IOException,
		...
		System.out.println("Test Case: TC_CANNM_0091 Start");
		// Preamble
		...
		//	if (cfg.chConf.get(0).CanNmRepeatMessageTime > 0) {
				...
				// Step 19
				//func.mNmBusSleepMode(v_ChannelIndex);
				
				// Step 20 & 21
				func.mCanNmGetState("VP21", v_NetworkHandle, Nm_StateType.NM_STATE_BUS_SLEEP,	Nm_ModeType.NM_MODE_BUS_SLEEP, Nm_ReturnType.NM_E_OK);
