...
public class TC_CANNM_0089 extends TC_CANNM {
	...
	public static double execute(String conf) throws ParserConfigurationException, SAXException, IOException,
		...
		System.out.println("Test Case: TC_CANNM_0089 Start");
		// Preamble
		...
		//	if (cfg.chConf.get(0).CanNmRepeatMessageTime > 0) {
				...
				// Step 19 & 20
				func.mCanNmGetState("VP20", v_NetworkHandle, Nm_StateType.NM_STATE_REPEAT_MESSAGE,	Nm_ModeType.NM_MODE_NETWORK, Nm_ReturnType.NM_E_OK);
		}
